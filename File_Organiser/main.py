...
def configure():
    print("Looks Like You are running the program for the first time!")
    print("So running the initial setup....")
    pic = input("Pictures Folder:  ")
    execu = input("Executables Folder: ")
    docu = input("Documents Folder: ")
    vids = input("Videos Folder: ")
    ...
    with open("details.json","w+") as file:
        ...
        print("[+] Setup completed successfully! Please restart the program!")
